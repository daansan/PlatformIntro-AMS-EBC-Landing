...
@mixin button-brand {
  ...
  border-color: $button-color-border-brand-primary;
  ...
  &:hover,
  &:focus {
    background-color: $color-background-brand-primary-hover;
    border-color: $color-border-brand-primary-hover;
    color: $color-text-brand-primary;
  }

  &:active {
    background-color: $color-background-brand-primary-active;
    border-color: $color-border-brand-primary-active;
  }
}
